...
const tweet_content = document.querySelector("#tweet_content");
const tweet_btn = document.querySelector(".tweet_submit");
const imgContainer = document.querySelector(".imgContainer");
const imgFile = document.querySelector("#imgPost");
...
/* =============== active/disable btn by depending on content ================== */

tweet_content.addEventListener("input", function (e) {
  if (this.value) {
...
/* =========== image upload[img show or remove function] =====================*/
...
imgContainer.addEventListener("click", function (e) {
  ...
  postImages.forEach((file, i) => {
    if (name === file.name) {
      ...
      img.remove();
      if (!postImages.length && !tweet_content.value) {
        tweet_btn.setAttribute("disabled", true);
      }
    }
  });
...
/* submit/create a post or tweet a post */

const tweetPost = document.querySelector("button#tweetPost");

tweetPost.addEventListener("click", function (e) {
  const content = tweet_content.value;
  if (postImages.length || content) {
